<?php
/**
 * Outputs the green Envira Gallery Footer
 *
 * @since   1.5.0
 *
...
<div class="envira-footer-promotion">
	<p><?php esc_html_e( 'Made with ♥ by the Envira Gallery Team', 'envira-gallery-lite' ); ?></p>
	<ul class="envira-footer-promotion-links">
		<li>
		<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/support', 'wpfooter', 'support' ) ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Support', 'envira-gallery-lite' ); ?></a><span>/</span>
		</li>
		<li>
		<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/docs', 'wpfooter', 'docs' ) ); ?>" target="_blank" rel="noopener noreferrer">Docs</a><span>/</span>
		</li>
		<li>
		<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=envira&page=envira-gallery-lite-about-us' ) ); ?>"><?php esc_html_e( 'Free Plugins', 'envira-gallery-lite' ); ?></a>
		</li>
	</ul>
	<ul class="envira-footer-promotion-social">
		<li>
		<a href="https://www.facebook.com/enviragallery" target="_blank" rel="noopener noreferrer">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Facebook', 'envira-gallery-lite' ); ?></span>
		</a>
		</li>
		<li>
		<a href="https://www.instagram.com/enviragallery" target="_blank" rel="noopener noreferrer">
			<svg width="16" height="16" aria-hidden="true">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Instagram', 'envira-gallery-lite' ); ?></span>
		</a>
		</li>
		<li>
		<a href="https://www.linkedin.com/company/envira-gallery/" target="_blank" rel="noopener noreferrer">
			<svg width="16" height="16" aria-hidden="true">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'LinkedIn', 'envira-gallery-lite' ); ?></span>
		</a>
		</li>
		<li>
		<a href="https://twitter.com/enviragallery" target="_blank" rel="noopener noreferrer">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Twitter', 'envira-gallery-lite' ); ?></span>
		</a>
		</li>
		<li>
		<a href="https://www.youtube.com/enviragallery" target="_blank" rel="noopener noreferrer">
			<svg width="17" height="16" aria-hidden="true">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'YouTube', 'envira-gallery-lite' ); ?></span>
		</a>
		</li>
	</ul>
</div>
